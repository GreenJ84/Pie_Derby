...
#======================== GetAll Pies created by User ==============
    ...
    def get_pie_byid(cls, data):
        ...
        results = connectToMySQL('pie_derby').query_db(query, data)
...
#========================== Update Recipe ====================
    ...
    def update_pie(cls, data):
        ...
        connectToMySQL('pie_derby').query_db(query, data)
...
#========================== Delete Recipe =====================
    ...
    def delete_pie(cls, data):
        ...
        connectToMySQL('pie_derby').query_db(query1, data)
        connectToMySQL('pie_derby').query_db(query2, data)
